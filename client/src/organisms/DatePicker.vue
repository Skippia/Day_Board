<script setup lang="ts">
    ...
    watch(currentMode, (mode) => {
        ...
        if (mode === 'single') {
            ...
            if (storeDatePicker.getToggleFilters[1].beforeRemove) storeDatePicker.getToggleFilters[1].beforeRemove()
        ...
        // [single --> multi]
            ...
            if (storeDatePicker.getToggleFilters[1].init) storeDatePicker.getToggleFilters[1].init()
        }
    })
